...
func (g *Generator) printGetter() {
	...
	g.printf("return r\n")
	g.printf("}\n")
	g.printf(`log.Printf("WARNING: role unknown for operator value %%d, will use default (attack)", i)` + "\n")
	g.printf(`log.Println("         post an issue on https://github.com/redraskal/r6-dissect")` + "\n")
	g.printf("return %s\n", g.roleValueAtk)
	g.printf("}\n")
}
