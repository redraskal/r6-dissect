...
const _Map_name = "CLUB_HOUSEKAFE_DOSTOYEVSKYKANALYACHTPRESIDENTIAL_PLANECONSULATEBARTLETT_UCOASTLINETOWERVILLAFORTRESSHEREFORD_BASETHEME_PARKOREGONHOUSECHALETSTADIUM_BRAVOSKYSCRAPERBORDERFAVELABANKOUTBACKEMERALD_PLAINS"
